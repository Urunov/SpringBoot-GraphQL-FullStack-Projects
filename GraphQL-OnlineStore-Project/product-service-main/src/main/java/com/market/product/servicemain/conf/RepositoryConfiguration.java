package com.market.product.servicemain.conf;

import com.market.product.servicemain.domain.Product;
...
public class RepositoryConfiguration {
    ...
    public MongoTemplate mongoTemplate() throws IOException{
        ...
        return new MongoTemplate((MongoClient) mongoBean.getObject(), "products_db");
    }
}
